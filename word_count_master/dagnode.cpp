...
DAGNode* DAGNode::init(){
    ...
    Task *task0 = new Task(filename1);
    Task *task1 = new Task(filename2);
    Task *task2 = new Task;
    Task *task3 = new Task;
    Task *task4 = new Task;


    DAGNode *DAGNode0 = new DAGNode(task0,Task::CreatArr,
                                     (void*)NULL,(void*)task0,NULL,0);// for createArr node
    DAGNode *DAGNode1 = new DAGNode(task1,Task::CreatArr,
                                     (void*)NULL,(void*)task1,DAGNode0,1);// for createArr node
    DAGNode *DAGNode2 = new DAGNode(task2,Task::merge_dict,
                                     (void*)NULL,(void*)task2,DAGNode0,2);// merge two dicts
    DAGNode *DAGNode3 = new DAGNode(task3,Task::QuickSort_shell,
                                     (void*)NULL,(void*)task3,DAGNode0,3);
    DAGNode *DAGNode4 = new DAGNode(task4,Task::write,
                                     (void*)NULL,(void*)task4,DAGNode0,4);

    DAGNode2->set_depedence(DAGNode0);
    DAGNode2->set_depedence(DAGNode1);
    DAGNode3->set_depedence(DAGNode2);
    DAGNode4->set_depedence(DAGNode3);
    ...
    DAGNode4->init_data();
/*
    DAGNode::execute(DAGNode0);
    DAGNode::execute(DAGNode1);
    DAGNode::execute(DAGNode2);
    DAGNode::execute(DAGNode3);
    DAGNode::execute(DAGNode4);
*/
  //  getchar();
   // DAGNode0->display();
